...
public class AktivnostDokument implements Serializable {
    ...
    @JoinColumn(name = "idAktivnosti", referencedColumnName = "idAktivnosti", insertable = false, updatable = false)
    ...
    public String toString() {
        return "com.model.AktivnostDokument[ aktivnostDokumentPK=" + aktivnostDokumentPK + " ]";
    }
